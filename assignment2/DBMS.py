...
#Deal with some special symbol such as ['" '' ; [] {} ()!@#%^&%^&]
#For part four, deal with primary owner
...
def func4(curs, connection,more):
	...
	if more == 'y':
		...
		#Same as what we deed for violatro_no
		...
		place = validity("Please enter the where did the violation occur: ", "Please enter a valid place in 20 digits: ", 20, str)
		...
		return func4(curs, connection,more)
